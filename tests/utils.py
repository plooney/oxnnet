"""Utility module used in testing and in creating dummy images"""
import sys
import os
import random
import numpy as np
...
def create_img_mask_seg_arrays():
    """Creates 3D numpy arrays for the Image, Mask and Segmentations"""
...
def write_nii(np_array, filename):
    """Writes a numpy array to a Nifti file"""
...
def write_test_cases(img_file_path, mask_file_path, seg_file_path):
    """Writes a single test cases Image, Mask and Segmentation given the respective file paths"""
...
def write_test_case(img_name):
    """Writes a single test case Image, Mask and Segmentation given the just the image file path without extension"""
